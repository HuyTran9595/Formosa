...
Shader "Greenworks/Flower" {
	Properties{
		...
		_Rrate("R", Range(0,1)) = 0.5
		_Grate("G", Range(0,1)) = 0.5
		_Brate("B", Range(0,1)) = 0.5
		_Grayish("Saturation", Range(0,4)) = 0.5
	...
	#pragma target 3.0
		...
		fixed4 c = fixed4(finalColor, 1); // Saturation
		c = lerp((c.r + c.g + c.b) / 3, c, _Grayish); // Saturation

		fixed4 finalRGBA = fixed4(finalColor,1);
		finalRGBA = c; // Saturation
